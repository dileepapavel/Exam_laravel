    ...
    <div class="row">
     <div class="col-md-12">
         ...
         <form method="post" action="/saveNotice">
            {{csrf_field()}}
            <b> <label for="name">Enter the Notice:</b>
        <input type="text" class="form-control" name="notice_content" placeholder="Enter your notice here ">
<br>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><a href="/deleteNotice/{{$notice->id}}" class="btn btn-warning">Delete</a>
                <a href="/updateNotice/{{$notice->id}}" class="btn btn-success">Update</a></td>
            </tr>
            @endforeach
        </table>
