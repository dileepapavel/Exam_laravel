            ...
            <div class="container">
            	<div class="inner-container">
                    <ul class="bread-crumb">
                       ...
                       <li><span>Update Results</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
@endforeach
        ...
        <form action="{{action('resultController@updateresult','$id')}}" method="post">
        {{csrf_field()}}
            <div class="form-group">
        <b> <label for="name">Enter the student's year:</b></label>
                  <select class="form-control"  name="year1" value="{{$resultdata->year}}" required="required">
            ...
            <input type="text" class="form-control" name="name1" value="{{$resultdata->Sname}}" placeholder="Enter the student's name...">
            <br>
            <div class="form-group">
        <b> <label for="name">Enter the module:</b></label>
                  <select class="form-control"  name="module1" value="{{$resultdata->module}}" required="required">
                  <option>&nbsp&nbsp&nbsp</option>
            ...
            <input type="text" class="form-control" name="mark1" value="{{$resultdata->resType}}" placeholder="Enter the student's mark...">
            <br>
