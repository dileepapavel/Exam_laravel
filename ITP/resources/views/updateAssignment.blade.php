            ...
            <div class="container">
            	<div class="inner-container">
                    <ul class="bread-crumb">
                       ...
                       <li><span>Update Assignments</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
@endforeach
        <form action="/updateAssignments" method="post">
        {{csrf_field()}}
            <input type="text" class="form-control" name="assignment_name" value="{{$assignmentdata->aName}}"/>
            <input type="hidden" name="id" value="{{$assignmentdata->id}}"/>
