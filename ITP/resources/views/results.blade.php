...
<body class="seo_version">
   ...
   <header class="header header_style_01">
            ...
            <div class="container">
            	<div class="inner-container">
                    <ul class="bread-crumb">
                       ...
                       <li><a href="result"><span> Results</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
    <form action="{{URL::to('/resultsearch')}}" method="POST" role="search">
    {{csrf_field()}}
    <div class="col-md-4">
    <form action="/resultsearch" name="resultsearch" class="form-control">
    <div class="input-group">
    <input type="search" name="resultsearch" class="form-control" placeholder="Enter Students's name here.....">
...
<div class="container">
    <div class="row">
        ...
        <b> <label for="name">Enter the student's year:</b></label>
            ...
            <br>
            <label for="name">Enter the student's name:</b></label>
            <input type="text" class="form-control" name="name" placeholder="Enter the student's name...">
            <br>
            <div class="form-group">
        <b> <label for="name">Enter the module:</b></label>
                  <select class="form-control"  name="module" required="required">
                  <option>&nbsp&nbsp&nbsp</option>
                      <option>Optometry</option>
                      <option>Refration</option>
                      <option>Vision</option>
                      <option>Vision Practicals</option>
                      <option>Vision Practicals</option>
                      <option>Histology</option>
                      <option>Clinical Practicals</option>
                    </select>
                </div>
            <br>
            <label for="name">Enter the student's mark:</b></label>
            <input type="text" class="form-control" name="mark" placeholder="Enter the student's mark...">
            <br>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>{{$res->module}}</td>
                    <td>{{$res->resType}}</td>
                    <td> <a href="/deleteResult/{{$res->id}}"  class="btn btn-warning">Delete</a>
                    <a href="/updateResult/{{$res->id}}" class="btn btn-success">Update</a></td>
                </tr>
                @endforeach
                </table><br><br>
                <a href="/resultReport" class="btn btn-success">Genarate Report</a>
        </div>
    </div>
</div>
<br><br><br><br>
