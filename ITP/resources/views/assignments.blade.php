...
<body class="seo_version">
            ...
            <div class="container">
            	<div class="inner-container">
                    <ul class="bread-crumb">
                        ...
                        <li><a href="/assignment"><span>Assignments</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
    <form action="{{URL::to('/assignmentsearch')}}" method="POST" role="search">
    {{csrf_field()}}
    <div class="col-md-4">
    <form action="/assignmentsearch" name="assignmentsearch" class="form-control">
    <div class="input-group">
    <input type="search" name="assignmentsearch" class="form-control" placeholder="Enter Assignment name here.....">
...
<input type="text" class="form-control" name="assignment_name" placeholder="enter your assignment name">
<br>
...
@foreach ($assignments as $ass)
            <tr>
                ...
                <td>{{$ass->aName}}</td>
                <td>{{$ass->Asub}}</td>
                <td> <a href="/deleteAssignment/{{$ass->id}}"  class="btn btn-warning">Delete</a>
                    <a href="/updateAssignment/{{$ass->id}}" class="btn btn-success">Update</a></td>
            </tr>
            @endforeach
</table>
<br><br><br><br>
